...
// @ts-ignore
import { MoviesRequestBuilderNavigationMetadata, MoviesRequestBuilderRequestsMetadata, type MoviesRequestBuilder } from './movies/index.js';
// @ts-ignore
...
// @ts-ignore
import { type WatchlistRequestBuilder, WatchlistRequestBuilderNavigationMetadata, WatchlistRequestBuilderRequestsMetadata } from './watchlist/index.js';
// @ts-ignore
...
export const MovieClientNavigationMetadata: Record<Exclude<keyof MovieClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    watchlist: {
        ...
        navigationMetadata: WatchlistRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
